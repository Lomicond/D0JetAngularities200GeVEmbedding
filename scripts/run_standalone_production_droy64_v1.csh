#!/bin/tcsh -f
#
# run_standalone_production_droy64_v1.csh
#
...
# Default test:
#
#   tcsh scripts/run_standalone_production_droy64_v1.csh
#
# Arguments:
#
...
#
#   Fresh 5-event run:
#       tcsh scripts/run_standalone_production_droy64_v1.csh 5 1 0
#
#   Resume from STARSIM:
#       tcsh scripts/run_standalone_production_droy64_v1.csh 5 4 0
#
#   Force only PicoDst:
#       tcsh scripts/run_standalone_production_droy64_v1.csh 5 6 1
#
...
set STANDJOB = \
"$D0WF/work/jobs/st_physics_15130045_raw_1000011_${NEVENTS}evts_standalone_droy64_v1"
...
set LOGDIR = \
"$STANDJOB/logs/run_standalone_production_droy64_v1_$RUN_TAG"
